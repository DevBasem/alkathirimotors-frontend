<template>
  <div>
    <div
      v-if="typeActive == 1"
      class="container purchasee"
      style="margin-top: 150px"
    >
      <h3 class="head" :data-purchase="$t('FIND WHAT YOU NEED')">
        {{ $t("PURCHASE ORDER") }}
      </h3>
        ...
        <div class="col-12 col-xl-5 col-lg-5 mb-4 thefixed">
          <div v-if="!pending" class="fixed-slide">
            ...
            <div class="new-car-card">
              ...
              <span>{{ mainCar.name }}</span>
            </div>
            <div class="d-flex alifgn-items-center justify-content-center">
              <span class="text-danger fw-bold text-center mt-1"
                >{{ $t("warning") }}
              </span>
            </div>
          </div>
          ...
          <div class="individual">
            <form action="" @submit.prevent>
              <div class="header">
                ...
                <span></span>
                <p @click="typeActive = 2" :class="{ active: typeActive == 2 }">
                  {{ $t("corporate") }}
                </p>
              </div>
              <div class="method">
                ...
                <div class="choose">
                  <span
                    @click="methodActive = 1"
                    class="text-center"
                    :class="{ active: methodActive == 1 }"
                    >{{ $t("finance") }}</span
                  >
                  <span
                    @click="methodActive = 2"
                    class="text-center"
                    :class="{ active: methodActive == 2 }"
                    >{{ $t("cash") }}</span
                  >
                </div>
              </div>
              <div class="finance" :class="{ active: methodActive == 1 }">
                ...
                <div class="inp">
                  ...
                  <select v-model="objPurchase.bank_id">
                    ...
                    <option v-for="bank in purchaseForm.banks" :value="bank.id">
                      {{ bank.name }}
                    </option>
                  </select>
                  <div
                ...
                <div class="inp">
                  ...
                  <input
                    type="number"
                    min="1"
                    v-model="objPurchase.commitments"
                    :placeholder="$t('Commitment amount...')"
                  />
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="commitmentsError"
                    >{{ commitmentsError }}</span
                  >
                </div>
                <div class="inpWithRadio d-flex flex-column gap-2">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <div class="d-flex align-items-center gap-2">
                        <input
                          ...
                          id="yes"
                          :value="1"
                          v-model="objPurchase.having_loan"
                        />
                  ...
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="having_loanError"
                    >{{ having_loanError }}</span
                  >
                </div>
                <div class="inpWithRadio d-flex flex-column gap-2">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <div class="d-flex align-items-center gap-2">
                        <input
                          ...
                          id="yes2"
                          :value="1"
                          v-model="objPurchase.having_personal_loan"
                        />
                  ...
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="having_loan_personal_error"
                    >{{ having_loan_personal_error }}</span
                  >
                </div>
                ...
                <div class="inp">
                  ...
                  <input
                    type="number"
                    min="1"
                    v-model="objPurchase.finance_duration"
                    :placeholder="$t('finance2')"
                  />
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="finance_duration_error"
                ...
                <div class="inpWithRadio d-flex flex-column gap-2">
                    ...
                    <div class="d-flex align-items-cente flex-colum gap-3">
                      <div class="d-flex align-items-center gap-2">
                        <input
                          ...
                          id="bankk1"
                          value="same_bank"
                          v-model="objPurchase.funding_organization_type"
                        />
                  ...
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="funding_organization_typeError"
                    >{{ funding_organization_typeError }}</span
                  >
                </div>

                <div
                  v-if="objPurchase.funding_organization_type == 'company'"
                  class="inp"
                >
                  ...
                  <div class="selectdiv">
                    <select v-model="objPurchase.funding_organization_id">
                      ...
                      <option
                        v-for="bank in purchaseForm.funding_organizations"
                        :value="bank.id"
                      >
                        {{ bank.name }}
                      </option>
                  ...
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="funding_organization_idError"
                    >{{ funding_organization_idError }}</span
                  >
                </div>
                <div
                  v-if="objPurchase.funding_organization_type == 'bank'"
                  class="inp"
                >
                  ...
                  <div class="selectdiv">
                    <select v-model="objPurchase.funding_bank_id">
                      ...
                      <option
                        v-for="bank in purchaseForm.banks"
                        :value="bank.id"
                      >
                        {{ bank.name }}
                      </option>
                  ...
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="funding_bank_idError"
                    >{{ funding_bank_idError }}</span
                  >
                </div>
                <div class="inp">
                ...
                <div
                  v-if="objPurchase.sector"
                  class="govern-section d-flex flex-column gap-2"
                >
                  <div class="inp">
                    ...
                    <span
                      class="errorMessage text-danger fw-bold"
                      v-if="id_and_driving_licenseError"
                      >{{ id_and_driving_licenseError }}</span
                    >
                  </div>
                  <div class="inp">
                    <label for="">{{
                      objPurchase.sector == "governmental"
                        ? `${$t("salary")}`
                        : `${$t("salary_def")}`
                    }}</label>
                    ...
                    <span
                      class="errorMessage text-danger fw-bold"
                      v-if="salary_identificationError"
                      >{{ salary_identificationError }}</span
                    >
                  </div>
                  ...
                  <div v-if="objPurchase.sector == 'private'" class="inp">
                    ...
                    <span
                      class="errorMessage text-danger fw-bold"
                      v-if="insurance_printError"
                      >{{ insurance_printError }}</span
                    >
                  </div>
                  <div v-if="objPurchase.sector == 'private'" class="inp">
                    ...
                    <span
                      class="errorMessage text-danger fw-bold"
                      v-if="account_statementError"
                      >{{ account_statementError }}</span
                    >
                  </div>
                </div>
                ...
                <div class="inp">
                  <div class="check d-flex align-items-center gap-3">
                    <input
                      ...
                      type="checkbox"
                      value="1"
                      v-model="objPurchase.terms_and_privacy"
                    />
              ...
              <div class="corporate" :class="{ active: methodActive == 2 }">
                ...
                <div class="inp">
                  ...
                  <div v-for="(box, index) in options" class="mt-1">
                    <div class="d-flex align-items-center gap-2 my-1">
                      <input
                        :id="`option-cash-${index}`"
                        type="checkbox"
                        v-model="objCash.services"
                        :value="box.id"
                      />
                      <label :for="`option-cash-${index}`">{{
                        box.name
                      }}</label>
                    </div>
                  </div>
                ...
                <div class="inp">
                  <div class="check d-flex align-items-center gap-3">
                    <input
                      ...
                      type="checkbox"
                      value="1"
                      v-model="objCash.terms_and_privacy"
                    />
                  ...
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="terms_and_privacyCashError"
                    >{{ terms_and_privacyCashError }}</span
                  >
                </div>
              </div>
            </form>
            <button
              v-if="methodActive == 1"
              :disabled="isLoading"
              class="d-flex custom-btn align-items-center justify-content-center gap-3"
              type=""
              @click="sendIndividual()"
            >
              <span>{{ $t("send") }}</span>
              <div
                v-if="spinnerBtn"
        ...
        <div class="col-12 col-xl-5 col-lg-5 mb-4 thefixed">
          <div class="fixed-slide">
            <p class="text">
              {{
                $t(
                  "Or please fill the form below: You will receive a reply within a maximum of 24 hours."
                )
              }}
            </p>
            <p>{{ $t("text purchase") }}</p>
            <div class="icons">
              ...
              <div class="icon d-flex align-items-center gap-3">
                ...
                <h4>
                  {{ $t("email") }}: <span>{{ generalData.email }}</span>
                </h4>
              </div>
              <div class="icon d-flex align-items-center gap-3">
                ...
                <h4>
                  ...
                  <a
                    target="_blank"
                    :href="`https://wa.me/${generalData.whatsapp}`"
                    class="click"
                    >{{ $t("click here") }}</a
                  >
                </h4>
          ...
          <div class="individual">
            <form action="" @submit.prevent>
              ...
              <div class="method">
                ...
                <div class="choose">
                  <span
                    @click="methodActiveCorparate = 1"
                    :class="{ active: methodActiveCorparate == 1 }"
                    >{{ $t("finance") }}</span
                  >
                  <span
                    @click="methodActiveCorparate = 2"
                    :class="{ active: methodActiveCorparate == 2 }"
                    >{{ $t("cash") }}</span
                  >
                </div>
              </div>
              <div class="finance active">
                <div class="d-flex flex-column">
                  <label class="fw-bold" for="" style="color: #1b395f">{{
                    $t("The selected vehicle *")
                  }}</label>
                  <div
                    class="inp d-flex gap-2 speciall"
                    v-for="(item, index) in form"
                    :key="item"
                  >
                    <!-- <input class="bigOne" type="text" :placeholder="$t('Vehicle name')" v-model="item.car_name"> -->
                    <div
                      class="d-flex flex-column flex-lg-row flex-md-row justify-content-center align-items-center justify-content-xl-start justify-content-lg-start justify-content-md-start gap-4"
                    >
                      <input
                        type="text"
                        class="first"
                ...
                <div class="inp">
                  ...
                  <input
                    type="text"
                    v-model="organization_ceo"
                    :placeholder="$t('The Chief Executive Officer (CEO)')"
                  />
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="organization_ceoError"
                ...
                <div class="inp">
                  ...
                  <input
                    type="tel"
                    v-model="phone_corporate"
                    :placeholder="$t('mobile number')"
                  />
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="phoneCorporateError"
                ...
                <div class="inp">
                  ...
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="organization_locationError"
                ...
                <div class="inp">
                  ...
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="organization_activityError"
                ...
                <div class="inp">
                  ...
                  <input
                    type="number"
                    min="0"
                    :placeholder="$t('Company age...')"
                    v-model="organization_age"
                    name=""
                  />
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="organization_ageError"
                ...
                <div class="inp">
                  ...
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="services_corporate_error"
                    >{{ services_corporate_error }}</span
                  >
                </div>
                

                <nuxt-link
                  v-if="methodActiveCorparate == 2"
                ...
                <div class="inp">
                  ...
                  <span
                    class="errorMessage text-danger fw-bold"
                    v-if="terms_and_privacy_error"
                    >{{ terms_and_privacy_error }}</span
                  >
                </div>
              </div>
...
const carDetail = async () => {
  ...
  let theCar = car.data.cars.filter((boxx) => {
    return boxx.id == id;
  });
  mainCar.value = theCar[0];
  image.value = car.data.images[0];
...
let objPurchase = ref({
  ...
  commitments: "",
  having_loan: "",
  city_id: selectedCountry1.value,
  work: "",
  services: [],
  bank_id: "",
  sector: "",
...
let objCash = ref({
  ...
  name: "",
  phone: "",
  city_id: selectedCountry2.value,
  bank_id: "",
  services: [],
  sector: "",
  account_statement: "",
...
let terms_and_privacyCashError = ref(null);
...
const sendIndividual = async () => {
  ...
  formData.append(
    "having_personal_loan",
    objPurchase.value.having_personal_loan
  );
  ...
  if (selectedCountry1.value) {
    formData.append("city_id", selectedCountry1.value.id);
  }
  ...
  formData.append("terms_and_privacy", objPurchase.value.terms_and_privacy);
  formData.append(
    "id_and_driving_license",
    objPurchase.value.id_and_driving_license
  );
  formData.append(
    "salary_identification",
    objPurchase.value.salary_identification
  );
  ...
  formData.append(
    "funding_organization_type",
    objPurchase.value.funding_organization_type
  );
  if (objPurchase.value.funding_organization_type == "company") {
    formData.append(
      "funding_organization_id",
      objPurchase.value.funding_organization_id
    );
  }
  ...
  let result = fetch(`${url}/individuals-orders`, {
    ...
    .then((json) => {
      ...
      if (json.message) {
        ...
        salaryError.value =
          json.errors.salary == undefined ? null : json.errors.salary[0];
        commitmentsError.value =
          json.errors.commitments == undefined
            ? null
            : json.errors.commitments[0];
        having_loanError.value =
          json.errors.having_loan == undefined
            ? null
            : json.errors.having_loan[0];
        cityError.value =
          json.errors.city_id == undefined ? null : json.errors.city_id[0];
        having_loan_personal_error.value =
          json.errors.having_personal_loan == undefined
            ? null
            : json.errors.having_personal_loan[0];
        workError.value =
          json.errors.work == undefined ? null : json.errors.work[0];
        financing_community_error.value =
          json.errors.financing_community == undefined
            ? null
            : json.errors.financing_community[0];
        finance_duration_error.value =
          json.errors.finance_duration == undefined
            ? null
            : json.errors.finance_duration[0];
        ageError.value =
          json.errors.age == undefined ? null : json.errors.age[0];
        bankError.value =
          json.errors.bank_id == undefined ? null : json.errors.bank_id[0];
        servicesCashError.value =
          json.errors.services == undefined ? null : json.errors.services[0];
        servicesError.value =
          json.errors.services == undefined ? null : json.errors.services[0];
        account_statementError.value =
          json.errors.account_statement == undefined
            ? null
            : json.errors.account_statement[0];
        id_and_driving_licenseError.value =
          json.errors.id_and_driving_license == undefined
            ? null
            : json.errors.id_and_driving_license[0];
        salary_identificationError.value =
          json.errors.salary_identification == undefined
            ? null
            : json.errors.salary_identification[0];
        insurance_printError.value =
          json.errors.insurance_print == undefined
            ? null
            : json.errors.insurance_print[0];
        sectorError.value =
          json.errors.sector == undefined ? null : json.errors.sector[0];
        funding_organization_idError.value =
          json.errors.funding_organization_id == undefined
            ? null
            : json.errors.funding_organization_id[0];
        funding_bank_idError.value =
          json.errors.funding_bank_id == undefined
            ? null
            : json.errors.funding_bank_id[0];
        funding_organization_typeError.value =
          json.errors.funding_organization_type == undefined
            ? null
            : json.errors.funding_organization_type[0];
...
const sendCash = async () => {
  ...
  formData.append("terms_and_privacy", objCash.value.terms_and_privacy);
  if (selectedCountry2.value) {
    formData.append("city_id", selectedCountry2.value.id);
  }
  ...
  let result = fetch(`${url}/individuals-orders`, {
    ...
    .then((json) => {
      ...
      isLoading.value = false;
      if (json.message) {
        phoneCashError.value =
          json.errors.phone == undefined ? null : json.errors.phone[0];
        nameCashError.value =
          json.errors.name == undefined ? null : json.errors.name[0];
        cityCashError.value =
          json.errors.city_id == undefined ? null : json.errors.city_id[0];
          terms_and_privacyCashError.value =
          json.errors.terms_and_privacy == undefined ? null : json.errors.terms_and_privacy[0];
      } else {
...
let terms_and_privacy = ref(false);
...
let terms_and_privacy_error = ref(null);
...
const sendCorporate = async () => {
  ...
  formData.append(
    "payment_type",
    methodActiveCorparate.value == 1 ? "finance" : "cash"
  );
  ...
  formData.append("terms_and_privacy", terms_and_privacy.value);
  if (city_id_corporate.value) {
    formData.append("city_id", city_id_corporate.value.id);
  }
  ...
  let result = fetch(`${url}/corporates-orders`, {
    ...
    .then((json) => {
      ...
      if (json.message) {
        organization_activityError.value =
          json.errors.organization_activity == undefined
            ? null
            : json.errors.organization_activity[0];
        organization_ageError.value =
          json.errors.organization_age == undefined
            ? null
            : json.errors.organization_age[0];
        organization_ceoError.value =
          json.errors.organization_ceo == undefined
            ? null
            : json.errors.organization_ceo[0];
        organization_emailError.value =
          json.errors.organization_email == undefined
            ? null
            : json.errors.organization_email[0];
        organization_locationError.value =
          json.errors.organization_location == undefined
            ? null
            : json.errors.organization_location[0];
        organization_nameError.value =
          json.errors.organization_name == undefined
            ? null
            : json.errors.organization_name[0];
        phoneCorporateError.value =
          json.errors.phone == undefined ? null : json.errors.phone[0];
        city_corporate_error.value =
          json.errors.city_id == undefined ? null : json.errors.city_id[0];
        services_corporate_error.value =
          json.errors.services == undefined ? null : json.errors.services[0];
        bank_number_imageError.value =
          json.errors.bank_number_image == undefined
            ? null
            : json.errors.bank_number_image[0];
        sectorErrorF.value =
          json.errors.sector == undefined ? null : json.errors.sector[0];
        insurance_printErrorF.value =
          json.errors.insurance_print == undefined
            ? null
            : json.errors.insurance_print[0];
            terms_and_privacy_error.value =
          json.errors.terms_and_privacy == undefined
            ? null
            : json.errors.terms_and_privacy[0];
        salary_identificationErrorF.value =
          json.errors.salary_identification == undefined
            ? null
            : json.errors.salary_identification[0];
        id_and_driving_licenseErrorF.value =
          json.errors.id_and_driving_license == undefined
            ? null
            : json.errors.id_and_driving_license[0];
        account_statementErrorF.value =
          json.errors.account_statement == undefined
            ? null
            : json.errors.account_statement[0];
