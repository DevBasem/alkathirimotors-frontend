    ...
    <div class="newSection mt-5">
        ...
        >
          <swiper-slide v-for="box in newsArray" class="box">
            ...
            <div class="image">
              <img :src="box.cover_image"  :data-src="box.cover_image" class="lazyload" loading="lazy"  src="~/assets/images/placeholder.png" alt="" />
            </div>
            <div class="text">
              <h3>{{ box.title }}</h3>
              ...
              <div class="detail" style="white-space: normal;">
                ...
                <div @click="goToNewsPage(box.title, box.id)" class="read d-flex align-items-center gap-1">
          ...
          <div v-for="product in newsArray" @click="goToNewsPage(product.title, product.id)" style="cursor: pointer; position:relative;" class="col-12 col-xl-3 col-lg-3 col-md-2 boxx ">
            ...
            <img class="mainpic lazyload" :data-src="product.cover_image"   loading="lazy"  src="~/assets/images/placeholder.png" :alt="product.title">
                <div class="textt">
                  <h4>{{ product.title }}</h4>
                  <client-only>
